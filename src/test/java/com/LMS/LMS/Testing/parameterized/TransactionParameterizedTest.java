...
public class TransactionParameterizedTest {
    ...
    public void testFindTransactionById(int id, int patronId, int bookId, String transactionDate, String dueDate, boolean isReturned) throws TransactionNotFoundException {
        Transaction transaction = new Transaction();
        transaction.setTransactionId(id);
        transaction.setPatron(new Patron());  // Mock or set proper Patron instance
        transaction.setBook(new Book());      // Mock or set proper Book instance
    ...
    public void testUpdateTransaction(int id, String transactionDate, String dueDate, boolean isReturned, boolean exists) throws TransactionNotFoundException {
        Transaction transaction = new Transaction();
        transaction.setTransactionId(id);
        transaction.setTransactionDate(LocalDate.parse(transactionDate));
        transaction.setDueDate(LocalDate.parse(dueDate));
    ...
    public void testDeleteTransactionById(int id, boolean exists) throws TransactionNotFoundException {
        if (exists) {
            Transaction transaction = new Transaction();
            transaction.setTransactionId(id);
            ...
            assertThrows(TransactionNotFoundException.class, () -> transactionService.deleteTransactionById(id));
        }
    }
}
